...
PreparedStatement ps=c.prepareStatement("insert into marks5(name,class,section,marks,test_type,total_marks) values (?,?,?,?,?,?)");
...
Connection c=  DriverManager.getConnection("jdbc:mysql://localhost:3306/d_b?useSSL=false","root","root123");
        System.out.println("connection established");
PreparedStatement ps=c.prepareStatement("insert into marks6(name,class,section,marks,test_type,total_marks) values (?,?,?,?,?,?)");
System.out.println("prepare statement working");
ps.setString(1,str1);
ps.setInt(2,n);
ps.setString(3,str3);
...
Connection c=  DriverManager.getConnection("jdbc:mysql://localhost:3306/d_b?useSSL=false","root","root123");
        System.out.println("connection established");
PreparedStatement ps=c.prepareStatement("insert into marks7(name,class,section,marks,test_type,total_marks) values (?,?,?,?,?,?)");
System.out.println("prepare statement working");
ps.setString(1,str1);
ps.setInt(2,n);
ps.setString(3,str3);
...
Connection c=  DriverManager.getConnection("jdbc:mysql://localhost:3306/d_b?useSSL=false","root","root123");
        System.out.println("connection established");
PreparedStatement ps=c.prepareStatement("insert into marks8(name,class,section,marks,test_type,total_marks) values (?,?,?,?,?,?)");
System.out.println("prepare statement working");
ps.setString(1,str1);
ps.setInt(2,n);
ps.setString(3,str3);
